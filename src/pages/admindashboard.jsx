...
const Dashboard = () => {
  return (
    <div className="flex w-screen h-screen bg-gray-100">
      {/* Sidebar */}
      <div className="bg-indigo-700 text-white w-64 px-4 py-8">
        <h1 className="text-2xl font-bold mb-8">Admin Panel</h1>
        <nav>
          <ul>
            <li className="mb-4">
              <Link to="/admin" className="flex items-center p-2 rounded hover:bg-indigo-600">
            ...
            <li className="mb-4">
              <Link to="/admin/users" className="flex items-center p-2 rounded hover:bg-indigo-600">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="mb-4">
              <Link to="/admin/products" className="flex items-center p-2 rounded hover:bg-indigo-600">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="mb-4">
              <Link to="/admin/analytics" className="flex items-center p-2 rounded hover:bg-indigo-600">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="mb-4">
              <Link to="/admin/settings" className="flex items-center p-2 rounded hover:bg-indigo-600">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <header className="bg-white shadow-sm">
          <div className="flex items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center">
              <button className="p-2 rounded-full bg-gray-100 text-gray-500 hover:text-gray-600 focus:outline-none">
